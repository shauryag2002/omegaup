      ...
      introJs()
        .setOptions({
          ...
          steps: [
            ...
            {
              element: document.querySelector('.introjs-school') as HTMLElement,
              title,
            ...
            {
              element: document.querySelector('.introjs-level') as HTMLElement,
              title,
            ...
            {
              element: document.querySelector('.introjs-submit') as HTMLElement,
              title,
